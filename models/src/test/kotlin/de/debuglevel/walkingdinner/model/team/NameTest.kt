...
class NameTest {
    ...
    fun nameProvider() = Stream.of(
            NameData(name = "John Dorian", expectedFirstname = "John", expectedLastname = "Dorian", expectedAbbreviatedName = "J. Dorian"),
            NameData(name = "Jennifer Dylan Cox", expectedFirstname = "Jennifer", expectedLastname = "Cox", expectedAbbreviatedName = "J. Cox"),
            NameData(name = "Robert-Bob Kelso", expectedFirstname = "Robert-Bob", expectedLastname = "Kelso", expectedAbbreviatedName = "R. Kelso")
    )
