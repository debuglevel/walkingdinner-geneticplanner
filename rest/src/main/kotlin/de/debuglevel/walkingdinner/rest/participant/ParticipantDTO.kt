    ...
    fun toTeam(): Team {
        return Team(
            Cook(
                ...
                MailAddress(
                    mail1 ?: throw IllegalArgumentException("mail1")
                ),
                PhoneNumber(
                    phone1 ?: throw IllegalArgumentException("phone1")
                )
            ),
            Cook(
                Name(chef2 ?: throw IllegalArgumentException("chef2")),
                MailAddress(
                    mail2 ?: throw IllegalArgumentException("mail2")
                ),
                PhoneNumber(
                    phone2 ?: throw IllegalArgumentException("phone2")
                )
            ),
